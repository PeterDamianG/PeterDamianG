 ...
 * @param {object} props - A object type SVGProps, with propieties pass to svg tag.
 * @example
 * import GoogleMailSVG from 'components/icons/socialmedia/GoogleMailSVG'
 * <GoogleMailSVG height={32} width={32} />
 */
const GoogleMailSVG = (props: SVGProps<SVGSVGElement>): JSX.Element => (
  <svg
